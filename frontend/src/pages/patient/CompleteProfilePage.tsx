...
import { useUpdatePatientProfile } from '@/features/profile/hooks/useProfileQueries'
...
const completeProfileSchema = z.object({
  user: z.object({
    status: z.enum(['active', 'locked', 'incomplete']),
  }),
...
export const CompleteProfilePage = () => {
  ...
  const { mutateAsync: updatePatientProfile, isPending: isUpdatePending } =
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      setFormError(null)
      try {
        await updatePatientProfile(completeProfileSchema.parse(value))
