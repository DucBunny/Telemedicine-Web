...
export const AppointmentCard = ({ appointment }: AppointmentCardProps) => {
  ...
  return (
    <div className="rounded-xl border border-l-4 border-gray-100 border-l-teal-500 bg-white p-4 ring-1 ring-slate-100 dark:bg-slate-800 dark:ring-slate-700">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button variant="teal_outline" className="h-7 md:text-xs" size="sm">
          Chi tiết
        </Button>
      </div>
    </div>
