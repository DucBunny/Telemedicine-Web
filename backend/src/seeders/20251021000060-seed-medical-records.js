  ...
  // Hô hấp (Liên quan SpO2 thấp)
  {
    ...
    prescriptions: [
      [
        {
          name: 'Ventolin (xịt)',
          dosage: 'Xịt khi khó thở, tối đa 4 lần/ngày',
          duration: '7 ngày',
        },
        {
          name: 'Ambroxol 30mg',
  ...
  // Sức khỏe bình thường / Bệnh nhẹ
  {
    ...
    prescriptions: [
      [
        {
          name: 'Enterogermina',
          dosage: '1 lọ x 2 lần/ngày',
          duration: '5 ngày',
        },
        {
          name: 'Oresol',
          dosage: 'Pha 1 gói / 200ml nước khi cần',
          duration: 'Khi có triệu chứng',
        },
      ],
      [
        {
          name: 'Paracetamol 500mg',
          dosage: '1 viên khi đau đầu, cách 6 giờ/lần',
          duration: '3 ngày',
        },
        {
          name: 'Vitamin 3B',
      ...
      [
        {
          name: 'Multivitamin',
          dosage: '1 viên sủi/ngày (pha với nước)',
          duration: '14 ngày',
        },
      ],
    ],
